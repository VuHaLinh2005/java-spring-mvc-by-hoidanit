    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <body>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <!-- <form action="/add-product-from-view-detail" method="post"
                                                ...
                                                <input class="form-control d-none" type="text" name="quantity"
                                                    id="cartDetails0.quantity"  value="1" /><!-- gan value mac dinh neu k se la 0 =err -->
                ...
                <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-toast-plugin/1.3.2/jquery.toast.min.js"></script><!-- th vien thong bao  -->
            </body>
